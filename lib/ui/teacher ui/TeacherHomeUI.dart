...
import 'package:slate/ui/teacher ui/TeacherUserUI.dart';
...
class _TeacherHomePage extends State<TeacherHomePage>{
  ...
  Widget homePage (BuildContext context){
    return  Scaffold(
        appBar: AppBar(
          title: Text(glb.teacher.schoolName , style: GoogleFonts.varelaRound(color: Colors.white,fontSize: W(3.5)),),
      ...
      body: ListView(
        children: [
          ...
          Padding(padding: EdgeInsets.only(top: H(8) , left: W(2)),
  ...
  Widget classRoomList (context){
    return StreamBuilder(
      stream: classRoomStream(context,glb.teacher.schoolID , glb.teacher.subjectList),
      builder: (context , snapshot){
        ...
        return ListView.builder(
          ...
          itemBuilder: (BuildContext context, index) {
            ...
            ClassRoom cr = ClassRoom.instructor(snapshot.data.docs[index]);
        ...
        child: TextButton(
          ...
          onPressed: () {
            Navigator.push(context, CupertinoPageRoute(
                builder: (context) =>  TeacherClassRoomUI(classRoom: classRoom) ));
          },
